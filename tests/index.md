...
| [VersionContract.test.ts](components/VersionContract.test.ts) | release owners | v1.9.3 synchronization across Cargo, Tauri, frontend, both lock surfaces of `frontend/package-lock.json`, the release contract and the changelog, plus the immutable canonical core release and commit |
