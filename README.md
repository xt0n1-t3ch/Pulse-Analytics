...
Pulse v1.9.2 ships Windows, macOS and Linux packages for x64 and ARM64. It adds Accounts, the Command Code provider and promoted Codex per-event session costs, and keeps the 1.8 storage and OpenCode work. Highlights:
...
| Platform | v1.9.2 downloads | Installer formats |
| --- | --- | --- |
| Windows | [x64](https://github.com/xt0n1-t3ch/Pulse-Claude-Code-Analytics/releases/download/v1.9.2/pulse-windows-x64-Pulse_1.9.2_x64-setup.exe) · [ARM64](https://github.com/xt0n1-t3ch/Pulse-Claude-Code-Analytics/releases/download/v1.9.2/pulse-windows-arm64-Pulse_1.9.2_arm64-setup.exe) | `.exe` (NSIS), `.msi` |
| macOS | [Intel](https://github.com/xt0n1-t3ch/Pulse-Claude-Code-Analytics/releases/download/v1.9.2/pulse-macos-x64-Pulse_1.9.2_x64.dmg) · [Apple Silicon](https://github.com/xt0n1-t3ch/Pulse-Claude-Code-Analytics/releases/download/v1.9.2/pulse-macos-arm64-Pulse_1.9.2_aarch64.dmg) | `.dmg`, app archive |
| Linux | [x64](https://github.com/xt0n1-t3ch/Pulse-Claude-Code-Analytics/releases/download/v1.9.2/pulse-linux-x64-Pulse_1.9.2_amd64.AppImage) · [ARM64](https://github.com/xt0n1-t3ch/Pulse-Claude-Code-Analytics/releases/download/v1.9.2/pulse-linux-arm64-Pulse_1.9.2_aarch64.AppImage) | `.deb`, `.rpm`, `.AppImage` |
...
The immutable [v1.9.2 release](https://github.com/xt0n1-t3ch/Pulse-Claude-Code-Analytics/releases/tag/v1.9.2) contains all six targets. The links above select NSIS, DMG or AppImage; MSI, DEB and RPM alternatives are on the release page. Native build/test checks passed; installed-GUI acceptance is recorded per operating system. See [platform verification](docs/maintainers/platforms.md).
...
Pulse v1.9.2 keeps Claude config schema 6 and Codex config schema 13, and migrates analytics to schema 7 by adding Accounts and Command Code data. Existing sessions are preserved. Pulse v1.8.2 cannot open analytics schema 7: back up the database before you install 1.9.2, and keep the schema-7 database separately if you return to 1.8.2.
...
Pulse consumes `codex-presence-core` 2.0.1 through an immutable Git pin recorded in [UPSTREAM.json](src/codex/UPSTREAM.json), promoted from the upstream v1.11.2 release. The standalone [Codex Discord Rich Presence](https://github.com/xt0n1-t3ch/Codex-Discord-Rich-Presence) runtime has its own releases and terminal interface.
