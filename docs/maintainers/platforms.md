...
On September 22, 2026, the immutable [v1.9.4 release](https://github.com/xt0n1-t3ch/Pulse-Analytics/releases/tag/v1.9.4) published all six targets from commit `178e37d821cc9ae94ab3b0d56b739d9069c6e2e1`. Its [release run](https://github.com/xt0n1-t3ch/Pulse-Analytics/actions/runs/35767661467) passed preflight, all six native jobs and publication, and the release has 24 assets. Earlier the same day, [v1.9.3](https://github.com/xt0n1-t3ch/Pulse-Analytics/releases/tag/v1.9.3) was published from `3e7d315a5718ed715e33dc9392e026f7a415e985` by [run 35762054646](https://github.com/xt0n1-t3ch/Pulse-Analytics/actions/runs/35762054646), also with all six targets and 24 assets. The workflow's own checksum, digest and updater-signature gates passed for both. The record below covers v1.9.2; the same checks were not repeated by hand for 1.9.3 or 1.9.4.

Windows x64 was upgraded in place from 1.9.2 to 1.9.3 and then to 1.9.4 on September 22, 2026. Each step used the downloaded NSIS installer after its SHA-256 matched `SHA256SUMS.txt` (1.9.4: `7eb62d9930560c2e70ed6d44acaee4d5a249afc1353def61ad84d4b3fdebc801`). Before each step, the exact running `pulse.exe` was stopped and a consistent SQLite backup (integrity `ok`, schema 7), the configuration and the previous executable were retained. The installed executable and the uninstall registration report 1.9.4, and ports 1420 and 1421 were not listening. For three live Claude Opus 5.5 sessions, installed costs matched an independent per-response transcript recomputation exactly. No other native host was tested by hand.
